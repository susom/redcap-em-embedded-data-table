...
function retrieveDataAcrossEvents($selectedProj, $config_info, $record_id) {
    ...
    $return_array = array("header" => $header,
                          "data" => $displayData);
...
<html lang="en">
    ...
    <body>
        <h3 style="text-align: center">Diary Report for <?php echo getHeader($pid, $record_id); ?></h3>

        <div class="container">

            <button id="print_button" class="btn btn-primary pull-right hidden-print" onclick="window.print();"><span class="glyphicon glyphicon-print" aria-hidden="true"></span> Print Page</button>

            <div class="accordion" id="accordionDisplays">

                 <?php $configNames= array("missed or partial doses", "allergic reactions", "health changes",
                    "clinic visits", "missing diary entries");
