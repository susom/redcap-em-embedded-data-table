...
function retrieveDataUsingFile($config_info, $record_id) {
    ...
    // There is a restriction that the function in the file which is called must be the same name as the file
...
<html lang="en">
    ...
    <body>
        <h3 style="text-align: center">Dosing Times for <?php echo getHeader($pid, $record_id); ?></h3>

        <div class="container">
            <div class="accordion" id="accordionDisplays">

                <?php $configNames = array("dosing time");
